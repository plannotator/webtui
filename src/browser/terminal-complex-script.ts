// Some foreground ANSI redraws paint background fills before glyphs settle.
// Detect those chunks so WebTUI can repaint the viewport without switching
// renderers based on the text content.
...
export function terminalOutputRequiresDomRenderer(_data: string): boolean {
  return false
}
